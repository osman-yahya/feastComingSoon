...
function Crew() {
    ...
    const crew = [
        { name: "Osman Yahya Akıncı", title: "Founder", desc: "2005 yılında İstanbul'da dünyaya gelmiştir. İstek Bilgekağan fen lisesi'nde eğitimini tamamladıktan sonra 2023 yılında İstanbul Teknik Üniversitesi'nde Bilgisayar Mühendisliği eğitimine başlamıştır.", img: osmanImg, linkedin: "https://www.linkedin.com/in/akincio/", insta: "https://www.instagram.com/oosmanyahya" },
